...
@implementation SSPlaceHolderTextView
...
- (instancetype)init {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(SSTextDidChanged:) name:UITextViewTextDidChangeNotification object:nil];
    
    return self;
}

- (void)SSTextDidChanged:(UITextView *)textView {
